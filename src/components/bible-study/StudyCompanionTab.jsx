...
export default function StudyCompanionTab() {
  ...
  return (
    <div className="flex flex-col h-[calc(100vh-14rem)] min-h-[400px]">
      <div className="flex items-center justify-between px-1 pb-3">
        ...
        <Button variant="outline" size="sm" onClick={startNewConversation} disabled={sending} className="gap-2 flex-shrink-0 ml-4">
